...
"Leta Change YouTube Quality" is a small, single-purpose extension for Chrome, Edge, Brave, and other Chromium-based browsers, and it's part of the LetaLab family of projects - you can find the rest of them at [https://LetaLab.eu](https://letalab.eu).
...
Running Firefox instead? There's a separate build for that: [Leta Change YouTube Quality for Firefox](https://github.com/LetaLab/Leta-Change-YouTube-Quality-Firefox).

## Screenshots

| Popup | Quality enforced on a video |
|---|---|
| <a href="https://github.com/user-attachments/assets/3ee60d64-638b-4d46-b9d9-a93cd47f3862"><img width="100%" alt="Popup" src="https://github.com/user-attachments/assets/3ee60d64-638b-4d46-b9d9-a93cd47f3862" /></a> | <a href="https://github.com/user-attachments/assets/22e075a3-17ca-424d-af81-2d252be72f82"><img width="100%" alt="Quality enforced" src="https://github.com/user-attachments/assets/22e075a3-17ca-424d-af81-2d252be72f82" /></a> |
...
- Your choice is saved instantly through `chrome.storage.sync` and stays put - no re-prompting, no reset on browser restart, no reset between videos
...
No network requests anywhere in this chain, no external dependencies, no build step - just vanilla ES2020+ and a Manifest V3 event-driven service worker instead of a persistent background page.
...
Running into that, or anything else that doesn't behave the way it should? Open a thread in [Issues](https://github.com/LetaLab/Leta-Change-YouTube-Quality/issues) and include the browser console output from a YouTube tab if you can - it makes tracking down the problem much faster.
